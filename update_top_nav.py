...
# Replace the header
old_header = """      <header className="flex items-center justify-between mb-6">
...
new_header = """      <header className="flex items-center justify-between bg-[#163848] px-6 py-4 rounded-xl shadow-md">
