...
with open(r"c:\Users\pvish\Zyvionix\Omni Projects\omni-boq-backend\src\catalog\manufacturers\manufacturers.controller.ts", "r", encoding="utf-8") as f:
    c = f.read()
...
with open(r"c:\Users\pvish\Zyvionix\Omni Projects\omni-boq-backend\src\catalog\manufacturers\manufacturers.controller.ts", "w", encoding="utf-8") as f:
    f.write(c)
